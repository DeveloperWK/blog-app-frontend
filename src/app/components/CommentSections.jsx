...
import useComments from "@/app/hooks/useComments";
 ...
 function CommentSection({ postId }) {
     ...
     const {fetchComments,newComment,setNewComment,error,isLoading,comments,handleEdit,handleDelete,handleUpdate,editingCommentId,editedComment,setEditedComment,cancelEdit,setIsLoading,setError} = useComments()
                        ...
                        comments?.comments?.map((comment) => (
                            ...
                            >
                                <div className="flex justify-between items-center mb-2">
                                    <div>
                                        <span className="font-medium text-white">{comment?.user?.firstName}</span>
