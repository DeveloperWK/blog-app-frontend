        ...
        <section className="glass p-6 rounded-xl shadow-xl">
          ...
          <ul className="space-y-4 mt-4">
            {/* Post Item  */}
              ...
              {!loading && usersCount === 0 && <Paragraph>No users found</Paragraph>}
              {!loading && users?.map((user) => (
                  <li className="flex justify-between items-center bg-opacity-10 rounded-lg border border-solid border-border_color py-3 px-6" key={user._id}>
