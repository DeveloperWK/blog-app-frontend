          ...
          <Flex className="w-[95%] mx-auto justify-between items-center py-3 md:py-2">
            ...
            >
              ...
              {isAuthenticated ? (
                  <>
                    {hasRole('writer') &&
                        <Link href="/users/post/write-post" className="md:order-3">
                      <Flex
                          className="gap-x-1 cursor-pointer border border-solid border-border_color w-10 h-10 rounded-full justify-center items-center md:border-none md:w-auto md:h-auto md:rounded-none hover:bg-border_color transition-colors duration-200">
