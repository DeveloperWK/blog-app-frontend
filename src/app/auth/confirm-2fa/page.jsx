...
const Confirm2fa = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsLoading(true)
const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URI}auth/two-factor-auth`, {
    method: "POST",
    headers: {
    ...
    return (
        <OTP otp={otp} handleChange={handleChange} handleSubmit={handleSubmit}
   isError={isError} isLoading={isLoading} headingText="Verify 2FA" path={path} />
